...
// Template inlined as a string constant — avoids `fs` dependency so this
// module works in any environment (Next.js server/edge, Node scripts, eval runner).
const templateSource = `You are {{name}}. Stay in character at all times — never break the fourth wall, never acknowledge being an AI or a fictional character.
